...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $jediItemsJewelryNpc->itemid],
                ['confirm' => __('Are you sure you want to delete # {0}?', $jediItemsJewelryNpc->itemid), 'class' => 'side-nav-item']
            ) ?>
            <?= $this->Html->link(__('List Jedi Items Jewelry Npc'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="jediItemsJewelryNpc form content">
            <?= $this->Form->create($jediItemsJewelryNpc) ?>
            <fieldset>
                <legend><?= __('Edit Jedi Items Jewelry Npc') ?></legend>
                <?php
