 ...
 * JediNpcSkills Model
 *
 * @method \App\Model\Entity\JediNpcSkill newEmptyEntity()
 * @method \App\Model\Entity\JediNpcSkill newEntity(array $data, array $options = [])
 * @method \App\Model\Entity\JediNpcSkill[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\JediNpcSkill get($primaryKey, $options = [])
 * @method \App\Model\Entity\JediNpcSkill findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \App\Model\Entity\JediNpcSkill patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\JediNpcSkill[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \App\Model\Entity\JediNpcSkill|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\JediNpcSkill saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\JediNpcSkill[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\JediNpcSkill[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \App\Model\Entity\JediNpcSkill[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\JediNpcSkill[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 */
class JediNpcSkillsTable extends Table
{
    /**
     * Initialize method
     *
